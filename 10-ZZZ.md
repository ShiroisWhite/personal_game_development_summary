...
- 崩坏3rd：初步尝试升维，即机械、生物、异能的属性克制(后续补充了量子、虚数等)，该体系**隐含了一个“伤害类型抵抗”的维度**。但因为整体较简单，所以游戏体验实质上还是攻防血暴的体系，膨胀在所难免，且膨胀速度在超限系统推出后迅速提升，本意是用来扶持老角色的举措，反而进一步拔高了养成的上限，老角色退环境现象严重。

![崩三属性克制](崩三属性克制.jpg)

- 原神：升维的典型案例，元素反应系统使得原本的**一维伤害计算公式变成了矩阵运算**，攻防双方的博弈从各个元素的维度展开，整体上的数值膨胀速度在预期之内，玩家配队百花齐放，不存在唯一最优解，且老角色保质期相当长久。后期元素反应体系逐渐复杂，理解门槛虽略有提高，但因为用户数量已经有足够的积淀，整体来说影响不大，可以说是升维成功的典范。

![原神元素反应](元素反应.png)

- 崩坏:星穹铁道：定位为休闲副游，升维程度有限，相当于在崩坏3rd属性护盾的基础上增加了击破效果，整体仍然倾向于单一维度的数值堆砌，因而数值膨胀也较为严重，加上角色推出频率较高，老角色退环境的速度也比较快。
![崩铁弱点击破](弱点击破.png)

- 绝区零：升维程度相比于原神有简化，不同伤害类型之间的反应只在触发紊乱时结算。直伤和异常双轨制，整体基本平衡，且膨胀速度明显处于可控范围。
